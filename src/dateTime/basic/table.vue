    ...
    <table class="sy-time-table">
        ...
        <tbody>
            <tr v-for="(row,index) in rows" :key="index">
                ...
                >
                    <div @click="clickday(item)" :class="getClass(item)" class="cell">{{ item.day }}</div>
                </td>
            </tr>
        </tbody>
    </table>
                ...
                switch (this.type) {
                    ...
                    case 'dateInterval':
                        if (this.dateArr.length === 2 ) {
                            if (inDateInterval(this.dateArr, itemDate)) arr.push('in-interval');
                        }
